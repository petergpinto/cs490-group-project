    ...
    showTestCases(questionId, userId) {
        ...
        return items.map((row, index) => {
            ...
            return <tr>
                ...
                {i == 2 ? <td rowspan="0"><input style={{ 'width': '200px', 'height': '200px' }} value={row.InstructorComment ? row.InstructorComment : null} examid={row.ExamId} userid={row.UserId} testcaseid={row.TestCaseId} onChange={this.addComment} type='text' /></td> : null}
                    </tr>
        }); 
    }
