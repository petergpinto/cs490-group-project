...
class ReviewExams extends Component {
	...
	showExamTotalPoints(userId) {
        ...
        return <div className='TestCaseTable'><table><tr><td>Total Points</td><td>{points}</td></tr><tr><td>Total Possible Points</td><td>{totalPossible.toFixed(2)}</td></tr><tr><td>Percentage Score</td><td>{(points / totalPossible)*100}</td></tr></table></div>
	}
